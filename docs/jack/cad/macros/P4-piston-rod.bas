Attribute VB_Name = "P4_piston_rod"
'==========================================================================
' PT-JACK-250  —  Piston rod Ø32
'
' Generated from docs/jack/cad/python/gen_sw.py. Units in the API are METRES.
'
' HOW TO RUN
'   1. SolidWorks > Tools > Macro > New...  (save as P4_piston_rod.swp)
...
Sub main()
    ...
    swModel.SketchManager.CreateCenterLine -0.010000, 0#, 0#, 0.430000, 0#, 0#
    swModel.SketchManager.CreateLine 0.000000, 0.000000, 0#, 0.000000, 0.011200, 0#
    swModel.SketchManager.CreateLine 0.000000, 0.011200, 0#, 0.045000, 0.011200, 0#
    swModel.SketchManager.CreateLine 0.045000, 0.011200, 0#, 0.045000, 0.022000, 0#
    swModel.SketchManager.CreateLine 0.045000, 0.022000, 0#, 0.053000, 0.022000, 0#
    swModel.SketchManager.CreateLine 0.053000, 0.022000, 0#, 0.053000, 0.016000, 0#
    swModel.SketchManager.CreateLine 0.053000, 0.016000, 0#, 0.385000, 0.016000, 0#
    swModel.SketchManager.CreateLine 0.385000, 0.016000, 0#, 0.385000, 0.011200, 0#
    swModel.SketchManager.CreateLine 0.385000, 0.011200, 0#, 0.420000, 0.011200, 0#
    swModel.SketchManager.CreateLine 0.420000, 0.011200, 0#, 0.420000, 0.000000, 0#
    swModel.SketchManager.CreateLine 0.420000, 0.000000, 0#, 0.000000, 0.000000, 0#
    swModel.SketchManager.InsertSketch True
    swModel.ClearSelection2 True
    SelectLastFeature
    ...
    swModel.ClearSelection2 True
    MsgBox "Piston rod Ø32 built. Save as P4_piston_rod.SLDPRT."
End Sub
