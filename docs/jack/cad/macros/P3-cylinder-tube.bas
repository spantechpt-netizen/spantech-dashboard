Attribute VB_Name = "P3_cylinder_tube"
'==========================================================================
' PT-JACK-250  —  Cylinder tube Ø50/Ø70 x 310
'
' Generated from docs/jack/cad/python/gen_sw.py. Units in the API are METRES.
'
' HOW TO RUN
'   1. SolidWorks > Tools > Macro > New...  (save as P3_cylinder_tube.swp)
...
Sub main()
    ...
    swModel.SketchManager.CreateCenterLine -0.010000, 0#, 0#, 0.320000, 0#, 0#
    swModel.SketchManager.CreateLine 0.000000, 0.025000, 0#, 0.310000, 0.025000, 0#
    swModel.SketchManager.CreateLine 0.310000, 0.025000, 0#, 0.310000, 0.035000, 0#
    swModel.SketchManager.CreateLine 0.310000, 0.035000, 0#, 0.000000, 0.035000, 0#
    swModel.SketchManager.CreateLine 0.000000, 0.035000, 0#, 0.000000, 0.025000, 0#
    swModel.SketchManager.InsertSketch True
    swModel.ClearSelection2 True
    SelectLastFeature
    ...
    swModel.ClearSelection2 True
    MsgBox "Cylinder tube Ø50/Ø70 x 310 built. Save as P3_cylinder_tube.SLDPRT."
End Sub
